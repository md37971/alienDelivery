...
class PropImage: #propClass.draw(x,y,l,w,image_index)
    ...
    def draw(self): #Other Props
        ...
        self.imageProp = pygame.image.load("images/sprites/" + imageArray[self.imageIndex] + ".png").convert_alpha()
    ...
    def deathSprite(self,audioFix,audioVolume): #Explosion Prop
        ...
        self.image = pygame.image.load("images/sprites/explosion.png").convert_alpha()
